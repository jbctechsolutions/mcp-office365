...
// No main-module heuristic here any more. `index.js` is the executable entry
// and calls main() explicitly, so importing this module never starts a server
// — which is what the tests rely on, and what the argv/symlink/npx sniffing
// this replaced was trying (unreliably) to approximate.
